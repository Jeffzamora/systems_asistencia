                    ...
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $department = $db->db->query("SELECT count(department_id) as `count` FROM `department_list` where status = 1 ")->fetch_assoc()['count'];
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $position = $db->db->query("SELECT count(position_id) as `count` FROM `position_list` where status = 1 ")->fetch_assoc()['count'];
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $enrollees = $db->db->query("SELECT count(employee_id) as `count` FROM `employee_list` where status = 1 ")->fetch_assoc()['count'];
                ...
                <div class="card-body">
                    <div class="w-100 d-flex align-items-center">
                        ...
                        <div class="col-auto flex-grow-1">
                            ...
                            <div class="fs-6 text-end fw-bold">
                                <?php 
                                $admin = $db->db->query("SELECT count(admin_id) as `count` FROM `admin_list`")->fetch_assoc()['count'];
