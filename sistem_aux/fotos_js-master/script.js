                ...
                $boton.addEventListener("click", function() {
                    ...
                    fetch("./guardar_foto.php", {
                        ...
                        .then(nombreDeLaFoto => {
                            ...
                            var jsonText = "";
                            // Realizar una solicitud a la API de IPinfo utilizando AJAX
                            fetch('http://ipinfo.io/json')
                            .then(response => response.json())
                            .then(data => {
                            console.log(data);
                            // aquí puede realizar lo que necesite con los datos de la respuesta, como actualizar su página web con la información de geolocalización
                            })
                            .catch(error => {
                            ...
                            $.ajax({
                                ...
                                method:'POST',
                                data:{type:nombre,json_data:jsonText,time:time,url:nombreDeLaFoto},
                                dataType:'json',
                                error:err=>{
                                    console.log(err)
