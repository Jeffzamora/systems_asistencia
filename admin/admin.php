        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <thead>
                <tr>
                    ...
                    <th class="text-center p-0">Tipo</th>
...
<script>
    $(function(){
        $('#create_new').click(function(){
            uni_modal('Agregar Nuevo Usuario',"manage_admin.php")
        })-
        $('.edit_data').click(function(){
            uni_modal('Editar Detalles de Usuario',"manage_admin.php?id="+$(this).attr('data-id'))
        })
