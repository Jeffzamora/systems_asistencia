...
if(isset($_GET['id'])){
$qry = $db->db->query("SELECT * FROM `employee_list` where employee_id = '{$_GET['id']}'");
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="department_id" id="department_id" class="form-select form-select-sm select2 rounded-0">
                            ...
                            <?php
                            $department = $db->db->query("SELECT * FROM department_list where `status` = 1 ".(isset($department_id) ? " or department_id ='{$department_id}'" : "")." order by `name` asc");
                    ...
                    <div class="form-group">
                        ...
                        <select name="position_id" id="position_id" class="form-select form-select-sm select2 rounded-0">
                            ...
                            <?php
                            $position = $db->db->query("SELECT * FROM position_list where `status` = 1 ".(isset($position_id) ? " or position_id ='{$position_id}'" : "")." order by `name` asc");
