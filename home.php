   ...
   <div class="w-100 d-flex justify-content-center my-2">
    ...
    <div class="w-100 row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-xl-2  gx-4 gy-4 justify-content-center my-2 mx-2">
            ...
            <div class="col text-center">
              <!--<a href="https://fepsoft.com/mb/n1/n1_v1/sistem_aux/fotos_js-master/index.php?type=IN"</a> prueba-->
            
            
            
            
            <a href="./sistem_aux/fotos_js-master/index.php?type=IN" ><button  class="att_btn2 w-100 text-center btn btn-sm rounded-0 btn-primary" type="button" data-type="IN">Hora de Ingreso</button> </a>                        
            </div>
                <div class="col text-center">
        ...
        <div class="col text-center">
        <a   href="./sistem_aux/fotos_js-master/index.php?type=OUT" > <button class=" att_btn2 w-100 text-center btn btn-sm rounded-0 btn-danger" type="button" data-type="OUT">Hora de Salida</button> </a>
        </div>
    </div>
    <div>
        ...
        <table class="table table-hover table-striped">
            <thead>
                <tr>
                    ...
                    <th class="py-1 px-2">Imagen</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                $log_type = array('IN'=>'Hora de Ingreso','L_OUT'=>'Salida a Descanso','L_IN'=>'Ingreso a Descanso','OUT'=>'Hora de Salida');
                $qry = $db->db->query("SELECT * FROM `attendance_list` where employee_id = '{$_SESSION['employee_id']}' order by attendance_id desc");
                ...
                ?>
                    <tr>
                        ...
                        <td> <img src="<?php echo "./sistem_aux/fotos_js-master/".$row['imagen'] ?>" alt="No requeridos" style="width:150px; heidth:150px;"></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
